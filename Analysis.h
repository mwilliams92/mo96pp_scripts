...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         SX3StripPosition[128];   //[SX3Mul]
   Float_t         SX3StripPositionCal[128];   //[SX3Mul]
   ...
   Float_t         xtals_cc1[128];   //[xtalsMul]
   ...
   TBranch        *b_SX3StripPosition;   //!
   TBranch        *b_SX3StripPositionCal;   //!
   TBranch        *b_icdE;   //!
   TBranch        *b_icE;   //!
   TBranch        *b_icWireX;   //!
   TBranch        *b_icWireY;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("data_combined",tree);
...
void Analysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("SX3StripPosition", SX3StripPosition, &b_SX3StripPosition);
   fChain->SetBranchAddress("SX3StripPositionCal", SX3StripPositionCal, &b_SX3StripPositionCal);
   ...
   fChain->SetBranchAddress("xtals_cc1", xtals_cc1, &b_xtals_cc1);
