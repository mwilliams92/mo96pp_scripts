...
*/
    // Out File
    TFile *outfile = new TFile("CoincPlots.root","RECREATE");
    // Directories:
    ...
    TDirectory *dirGam = outfile->mkdir("Gamma-rays");
    TDirectory *dirExcGam = outfile->mkdir("Excitation_v_Gamma");
    ...
    TCut gamma778 = "Egamma>774 && Egamma<782"; 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    hExc->SetLineColor(1);
    TH1D *hExc_Gated = new TH1D("hExc_Gated","Excitation Energy Time Gated",2000,-5,15);
    ...
    TH1D *hExc_Gated3 = new TH1D("hExc_Gated3","Excitation Energy Gated on 778keV",2000,-5,15);
    data->Draw("Excitation>>hExc_Gated3",ValidHit + Protons + gamma778,"same");
    ...
    legend0->AddEntry(hExc_Gated3,"778 keV Gamma","l");
   	legend0->Draw();
    ...
    //data->Draw("Excitation>>hExc_Gated2",ValidHit + Protons + Silicon_GRETINA_TDC,"same");
    //hExc_Gated2->SetLineColor(4);
    TH1D *hExc_Gated3_16O = new TH1D("hExc_Gated3_16O","Excitation Energy Gated on 778keV",2000,-5,15);
    data->Draw("Excitation_O16>>hExc_Gated3_16O",ValidHit + Protons + gamma778,"same");
    hExc_Gated3_16O->SetLineColor(4);
    ...
    legend3->AddEntry(hExc_Gated3_16O,"778 keV Gamma","l");
   	legend3->Draw();

    hExc16O->Write();
    hExc_Gated16O->Write();
    hExc_Gated3_16O->Write();
    cExc16O->Write();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Gamma-Ray Spectra
    dirGam->cd();
    TCanvas *cGam = new TCanvas("cGam");
    TH1D *hGam = new TH1D("hGam","Gamma Energy",10000,0,10000);
    data->Draw("Egamma>>hGam",ValidHit + Protons);
    hGam->Write();
    cGam->Write();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Excitation vs Gamma
    dirExcGam->cd();
    TCanvas *cExcGam = new TCanvas("cExcGam");
    TH2D *hExcGam = new TH2D("hExcGam","Excitation Energy v Gamma",10000,0,10000,2000,-5,15);
    data->Draw("Excitation:Egamma>>hExcGam",ValidHit + Protons,"colz");
    hExcGam->Write();
    cExcGam->Write();
